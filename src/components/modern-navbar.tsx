...
const MobileMenu = memo(
  ({
    ...
    return (
      <div className="md:hidden mt-4 pb-4 absolute left-0 right-0 top-full bg-white shadow-lg z-50 border-t">
        <nav className="flex flex-col space-y-2 p-4">
          ...
          <div className="flex flex-col space-y-2 pt-2 border-t border-gray-200">
            ...
            <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
              <Link href="/bao-gia" onClick={() => setIsMobileMenuOpen(false)}>
                Báo giá
              </Link>
            </Button>
          </div>
...
export const ModernNavbar = memo(function ModernNavbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-lg py-2" : "bg-white/90 backdrop-blur-md shadow-md py-3"}`}
    >
      <div className="container mx-auto px-4">
              ...
              <div key={item.href} className="relative">
                {item.dropdown ? (
                  <div className="relative">
                    ...
                    {activeDropdown === item.href && (
                      <div
                        className="absolute top-full left-0 mt-1 w-56 bg-white rounded-md shadow-lg py-1 z-20"
                        role="menu"
        ...
        {/* Mobile Menu - Extracted to separate component for performance */}
        <MobileMenu
